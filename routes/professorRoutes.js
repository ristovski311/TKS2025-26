 ...
 *         description: Server error
 */
router.get("/search", findProfessors);
 ...
 *         description: Server error
 */
router.get("/:id", fetchProfessorById);
router.put("/:id", modifyProfessor);
router.delete("/:id", removeProfessor);
